...
`cases/incremental-release-progression.json` is a 0.2.0 supplemental maintenance corpus. It distinguishes
...
`cases/canon-orchestration.json` is a 0.2.0 supplemental static-contract corpus. It records expected
